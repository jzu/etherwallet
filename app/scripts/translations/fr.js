...
fr.data = {
  ...
  SEND_TransferTotal:    'Transférer la totalité du montant disponible',
  SENDModal_Title:       'Attention ! ',
  /* full sentence reads "You are about to send "10 ETH" to address "0x1234". Are you sure you want to do this? " */
  SENDModal_Content_1:   'Vous aller envoyer',
  SENDModal_Content_2:   'à l\'adresse',
  SENDModal_Content_3:   'En êtes-vous vraiment sûr ?',
  SENDModal_Content_4:   'NOTE: Si vous rencontrez une erreur, il vous faut très probablement ajouter des ETH à votre compte pour couvrir les coûts en gas d\'envoi des jetons. Le gas est payé en ETH.',
  ...
  /* Send Transaction */
  TRANS_desc:            'Si vous voulez envoyer des tokens, utilisez plutôt la page « Envoyer des tokens ».',
  TRANS_warning:         'Si vous utilisez les fonctions « ETH seulement » ou « ETC seulement », vous passez par un contrat. Certains services peuvent poser problème avec ces transactions. En savoir plus.',
  TRANS_standard:        'ETH (transaction standard)',
  TRANS_eth:             'ETH seulement',
  TRANS_etc:             'ETC seulement',
  TRANS_advanced:        '+Avancé : ajouter du gas ou des données ',
  TRANS_data:            ' Données : ',
  TRANS_gas:             ' Gas : ',
  TRANS_sendInfo:        'Une transaction standard utilisant 21000 gas coûte A standard transaction using 21000 gas coûtera 0.000441 ETH. Nous avons chois un prix du gas légèrement supérieur au minimum de 0.000000021 ETH pour assurer une confirmation rapide. Nous ne prenons pas de frais pour les transactions.',

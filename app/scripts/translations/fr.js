...
fr.data = {
  ...
  TRANSModal_Content_0:  'Note concernant les transactions et services divers :',
  TRANSModal_Content_1:  '**ETH (transaction standard) : ** Ceci génère une transaction par défaut directement d\'une adresse vers une autre. Son gaz par défaut est de 21000. Il est probable que tout ETH envoyé par ce biais sera rejoué sur la chaîne ETC.',
  TRANSModal_Content_2:  '**ETH seulement : ** L\'envoi est réalisé à travers le [contrat anti-rejeu de Timon Rapp\'s (recommandé par VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) afin de n\'envoyer que sur la chaîne **ETH**.',
  TRANSModal_Content_3:  '**ETC seulement : ** L\'envoi est réalisé à travers le [contrat anti-rejeu de Timon Rapp\'s (recommandé par VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) afin de n\'envoyer que sur la chaîne **ETC**. ',
  TRANSModal_Content_4:  '**Coinbase & ShapeShift : ** N\'envoyer que par transaction standard. Si vous envoyez par un contrat (ETH ou ETC seulement), vous devrez accéder à leur équipe de support pour le faire ajouter manuellement à votre solde ou vous faire rembourser. [Vous pouvez aussi essayer l\'outil "split" de Shapeshift.](https://split.shapeshift.io/)',
  ...
  OFFLINE_Desc:          'La génération de transactions hors ligne peut être effectuée en trois étapes. Les étapes 1 et 3 seront réalisées sur un ordinateur en ligne et l\'étape 2 sur un ordinateur déconnecté du réseau Cela vous permet d\'éviter tout contact entre vos clefs privées et une machine connectée à l\'internet.',
  OFFLLINE_Step1_Title:  'Étape 1 : Génération d\'information (ordinateur en ligne)',
  OFFLINE_Step1_Button:  'Generation d\'information',
  OFFLINE_Step1_Label_1: 'Depuis l\'adresse : ',
  OFFLINE_Step1_Label_2: 'Note : Ceci est l\'adresse d\'émission et non de destination. Le nonce est généré depuis le compte émetteur. Si une machine déconnectée est utilisée, c\'est donc l\'adresse du compte de ce _cold storage._',
  OFFLLINE_Step2_Title:   'Étape 2 : Génération de la transaction (ordinateur hors ligne)',
  ...
  OFFLINE_Step2_Label_3b: 'Ceci a été affiché à l\'étape 1 sur votre ordinateur en ligne.',
  OFFLINE_Step2_Label_4:  'Limite de gaz ',
  OFFLINE_Step2_Label_4b: '21000 est la limite de gaz par défaut. Quand vous envoyez à des contrats ou avec des données supplémentaires, cette valeur peut devoir être changée. Tout gaz non consommé vous sera renvoyé.',
  OFFLINE_Step2_Label_5:  'Nonce',
  OFFLINE_Step2_Label_5b: 'Ceci a été affiché à l\'étape 1 sur votre ordinateur en ligne.',
  OFFLINE_Step2_Label_6:  'Données',
  OFFLINE_Step2_Label_6b: 'Ceci est optionnel. Les données sont souvent utilisées quand on envoie des transactions à des contrats.',
  OFFLINE_Step2_Label_7:  'Entrez / sélectionnez votre clef privée ou votre JSON.',
  OFFLINE_Step3_Title:    'Étape 3 : Envoi / publication de la transation (ordinateur en ligne)',
  OFFLINE_Step3_Label_1:  'Copiez ici la transaction signée à l\'étape 2 et cliquez sur le bouton "SEND TRANSACTION".',
